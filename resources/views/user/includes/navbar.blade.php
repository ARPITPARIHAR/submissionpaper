...
<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-8 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px; ">
                    ...
                    <small class="me-3 mb-2 text-light">
                        <i class="fa fa-phone-alt me-2"></i>
                        <a href="tel:+0123456789" style="color:#fff65f;">+012 345 6789</a>
                      </small>
                      
                    <small class="mb-2 text-light">
    ...
    <h1 class="m-0"><i class="fa fa-user-tie me-2"></i>SubmissionPaper</h1>
</a>   
